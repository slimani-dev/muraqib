@php
    $plugin =
        function_exists('filament') && filament()->isServing()
            ? \Leandrocfe\FilamentApexCharts\FilamentApexChartsPlugin::get()
            : null;
...
<x-filament-widgets::widget
    class="fi-netdata-network-widget fi-wi-chart filament-widgets-chart-widget filament-apex-charts-widget">
    <x-filament-actions::modals />

    <x-filament::section class="filament-apex-charts-section" :description="$subheading" :heading="$heading" :collapsible="$isCollapsible">
