...
- [ ] `laravel new muraqib --git` (Laravel 12).
    
- [ ] Install `inertiajs/inertia-laravel` and Vue 3 stack.
    
- [ ] Install `laravel/wayfinder`.
    
- [ ] Configure Tailwind CSS with the "Muraqib" color palette (Slate 900/Indigo 500).
...
- [ ] Create `MainLayout.vue`: Sidebar (Collapsible), TopBar (Sticky), Slot (Content).
    
- [ ] Implement `Wayfinder` logic for navigation menu generation.
    
- [ ] Create the "Dashboard" and "Settings" placeholder pages.
    
- [ ] **Commit:** "UI Shell complete"
...
- [ ] **Commit:** "Settings Vault backend logic"
